      ...
      <div className="flex items-center justify-between mb-7 flex-wrap gap-3">
        ...
        <button
          ...
          className={`text-[0.8rem] font-semibold px-3 py-1.5 rounded-xl border-none cursor-pointer font-sans ${
            available ? 'bg-crewGreen-light text-crewGreen' : 'bg-crewSurface2 text-crewSlate-light'
          }`}
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-white border border-crewSlate/10 rounded-xl p-6">
          <div className="flex justify-between items-center mb-5">
            ...
            <Link href="/dashboard/timeline" className="text-[0.78rem] text-crewAmber-dark no-underline font-medium">
              View Timeline →
            </Link>
          </div>
        ...
        <div className="bg-white border border-crewSlate/10 rounded-xl p-6">
          <div className="flex justify-between items-center mb-5">
            ...
            <Link href="/dashboard/reviews" className="text-[0.78rem] text-crewAmber-dark no-underline font-medium">
              All Reviews →
            </Link>
          </div>
