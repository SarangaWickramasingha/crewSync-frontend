export const fieldClass =
  'w-full border border-black/10 rounded-lg px-3 py-2 text-sm text-crewSlate bg-white outline-none ' +
  'focus:border-crewAmber focus:ring-2 focus:ring-crewAmber/10 transition-all';

export const selectClass = `${fieldClass} cursor-pointer`;
...
export const ghostBtnClass =
  ...
  'hover:bg-crewSurface transition-colors';
