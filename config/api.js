// ── API BASE ───────────────────────────────────────────────────────────────────
export const API_BASE = process.env.NEXT_PUBLIC_API_BASE || 'https://crewsync-1sis.onrender.com/backend/index.php';
...
export const API_MATERIAL_ORDER_CREATE = `${API_BASE}/api/supplier/orders`;
